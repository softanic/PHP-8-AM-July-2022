                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Create an Account with softChat!</h1>
                            </div>
                            <form class="user" action="signup-otp-check.php" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                        ...
                                        <input type="number" autofocus class="form-control form-control-user"
                                            id="exampleInputPassword" placeholder="ENTER OTP" name="otp">
